window.portfolioData = {
    ...
    "socials": [
        {
            "platform": "GitHub",
            "url": "https://github.com/HRS0986",
            "icon": "fab fa-github",
            "color": "hover:text-gray-900 dark:hover:text-white"
        },
        {
            "platform": "LinkedIn",
            "url": "https://www.linkedin.com/in/hirusha-fdo/",
            "icon": "fab fa-linkedin-in",
            "color": "hover:text-blue-600"
        },
        {
            "platform": "StackOverflow",
            "url": "https://stackoverflow.com/users/12063253/hirusha-fernando",
            "icon": "fab fa-stack-overflow",
            "color": "hover:text-orange-500"
        },
        {
            "platform": "Medium",
            "url": "https://heshanhfernando.medium.com/",
            "icon": "fab fa-medium",
            "color": "hover:text-black dark:hover:text-white"
        },
        {
            "platform": "BuyMeACoffee",
            "url": "https://buymeacoffee.com/hirushafernando",
            "icon": "fas fa-coffee",
